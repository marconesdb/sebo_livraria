...
export default function Login() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (email && password) {
      setAuth(
        { id: '1', name: 'Usuário Teste', email, role: 'customer' },
        'mock-jwt-token'
      );
    ...
    <div className="flex min-h-[80vh] items-center justify-center px-4 py-12">
      <div className="w-full max-w-md space-y-8 rounded-2xl border bg-white p-8 shadow-xl">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <label className="ml-2 block text-sm text-gray-600">Lembrar de mim</label>
            </div>
            <a href="#" className="text-sm font-medium text-emerald-600 hover:underline">Esqueceu a senha?</a>
          </div>

          <button
            type="submit"
            className="group relative flex w-full justify-center rounded-xl bg-emerald-600 py-3 text-sm font-bold text-white transition-colors hover:bg-emerald-700"
          >
            Entrar
        ...
        <div className="grid grid-cols-2 gap-4">
          <button className="flex items-center justify-center gap-2 rounded-xl border py-2 text-sm font-medium hover:bg-gray-50">
